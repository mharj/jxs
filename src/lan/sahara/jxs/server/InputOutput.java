...
public class InputOutput {
	 ...
	 * 
	 * @param ba
	 *            The array to store the bytes to.
	 * @param offset
	 *            The start position in the array to store the bytes.
	 * @param length
	 ...
	 * 
	 * @param bits
	 *            The array to store the bits to.
	 * @param offset
	 *            The start position in the array to store the bits.
	 * @param length
	 ...
	 * @param offset
	 *            The start position in the array to write from.
	 * @param length
	 ...
	 * 
	 * @param n
	 *            The number of times to write the byte.
	 * @throws IOException
	 */
